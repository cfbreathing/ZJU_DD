...
HD_PWD='C:/Users/15390/Desktop/DD/Mylab/lab5/LampCtrl/LampCtrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LampCtrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LampCtrl.tcl
