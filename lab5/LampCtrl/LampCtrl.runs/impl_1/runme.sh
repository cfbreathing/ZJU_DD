...
HD_PWD='C:/Users/15390/Desktop/DD/Mylab/lab5/LampCtrl/LampCtrl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LampCtrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LampCtrl.tcl -notrace
