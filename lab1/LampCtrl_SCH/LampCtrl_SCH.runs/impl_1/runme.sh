...
HD_PWD='C:/Users/15390/Desktop/DD/Mylab/lab1/LampCtrl_SCH/LampCtrl_SCH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lamp_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lamp_ctrl.tcl -notrace
