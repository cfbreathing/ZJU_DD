...
HD_PWD='C:/Users/15390/Desktop/DD/Mylab/lab1/LampCtrl_SCH/LampCtrl_SCH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lamp_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lamp_ctrl.tcl
